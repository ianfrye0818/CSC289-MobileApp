...
export default function OrderDetailScreen({ order }: Props) {
  ...
  const hasShipping = order.shipping !== null && !isNil(order.shipping.id);
  ...
  return (
    ...
    >
      ...
      <Card className='gap-0 px-4 py-3'>
        ...
        <View className='gap-2'>
          <View className='flex-row items-center justify-between'>
            ...
            <Text className='text-foreground text-sm'>{getPaymentLabel(order.payment.method)}</Text>
          </View>
          <View className='flex-row items-center justify-between'>
      ...
      {hasShipping ? (
          ...
          <View className='gap-2'>
            ...
            {order.shipping!.carrier && (
              <View className='flex-row items-center justify-between'>
                ...
                <Text className='text-foreground text-sm'>{order.shipping!.carrier}</Text>
              </View>
            )}
        ...
        <Card className='gap-0 px-4 py-3'>
          <Text className='font-semibold text-base text-foreground mb-2'>Shipping</Text>
          <Text className='text-muted-foreground text-sm'>No shipping information available</Text>
        </Card>
      )}
