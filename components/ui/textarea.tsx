...
function Textarea({
  ...
  return (
    <TextInput
      className={cn(
        'text-foreground border-input bg-background dark:bg-input/30 flex min-h-16 w-full flex-row rounded-md border px-3 py-2 text-base shadow-sm shadow-black/5 md:text-sm',
        Platform.select({
